...
sub GetLayout {
	...
	my $btnLastConfig    = Wx::Button->new( $pnlMain, -1, "Last configuration", &Wx::wxDefaultPosition, [ 120, 25 ] );
	...
	$szRowBtns->Add( $btnGenGroup,      1, &Wx::wxEXPAND | &Wx::wxALL, 0 );
