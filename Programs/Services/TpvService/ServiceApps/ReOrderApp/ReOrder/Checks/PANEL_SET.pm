...
# Author:SPR
#-------------------------------------------------------------------------------------------#
package Programs::Services::TpvService::ServiceApps::ReOrderApp::ReOrder::Checks::PANEL_SET;
...
if ( $filename =~ /DEBUG_FILE.pl/ ) {
	...
	use aliased 'Programs::Services::TpvService::ServiceApps::ReOrderApp::ReOrder::Checks::PANEL_SET' => "Change";
