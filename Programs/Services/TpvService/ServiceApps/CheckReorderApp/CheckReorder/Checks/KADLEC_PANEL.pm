...
# Author:SPR
#-------------------------------------------------------------------------------------------#
package Programs::Services::TpvService::ServiceApps::CheckReorderApp::Reorder::Checks::KADLEC_PANEL;
...
if ( $filename =~ /DEBUG_FILE.pl/ ) {
 	...
 	use aliased 'Programs::Services::TpvService::ServiceApps::CheckReorderApp::Reorder::Checks::KADLEC_PANEL' => "Change";
