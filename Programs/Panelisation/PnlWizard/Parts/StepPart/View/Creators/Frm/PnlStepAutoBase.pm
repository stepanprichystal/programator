...
#	Wx::Event::EVT_TEXT( $pcbStepValTxt, -1, sub { $self->{"creatorSettingsChangedEvt"}->Do() } );
...
#	
#	Wx::Event::EVT_RADIOBUTTON( $rbPlacementAuto,  -1, sub { $self->{"creatorSettingsChangedEvt"}->Do() } );
