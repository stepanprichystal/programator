...
package Programs::Panelisation::PnlWizard::Parts::StepPart::View::Creators::ClassUserFrm;
...
sub new {
	...
	my $self = $class->SUPER::new( PnlCreEnums->StepPnlCreator_CLASSUSER, $parent, $inCAM, $jobId );
