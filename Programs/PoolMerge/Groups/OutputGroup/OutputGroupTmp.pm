package Programs::PoolMerge::Groups::OutputGroup::OutputGroupTmp;
...
#use aliased 'Programs::Exporter::ExportOutputer::Groups::OutputGroup::Presenter::AOIUnit';
use aliased 'Managers::MessageMngr::MessageMngr';
use aliased "Programs::PoolMerge::Task::TaskData::DataParser";
use aliased "Programs::PoolMerge::Groups::OutputGroup::OutputWorkUnit" => "Unit";
...
sub new {
	...
	$self->{"id"} =  UnitEnums->UnitId_OUTPUT;
