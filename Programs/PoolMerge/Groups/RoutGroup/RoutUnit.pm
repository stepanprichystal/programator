...
# Author:SPR
#--------------------------------------------------------------------------------------------
package Programs::PoolMerge::Groups::RoutGroup::RoutUnit;
...
use aliased 'Programs::PoolMerge::Groups::RoutGroup::RoutGroup';
...
sub new {
	...
	$self->{"unitTaskClass"} = RoutGroup->new($self->{"unitId"});
