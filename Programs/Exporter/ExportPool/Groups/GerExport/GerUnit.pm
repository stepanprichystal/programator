...
# Author:SPR
#-------------------------------------------------------------------------------------------#
package Programs::Exporter::ExportPool::Groups::GerExport::GerUnit;
...
use aliased 'Programs::Exporter::ExportPool::Groups::GerExport::GerExport';
...
sub new {
	...
	$self->{"unitExport"} = GerExport->new($self->{"unitId"}, UnitEnums->GetTitle($self->{"unitId"}));
