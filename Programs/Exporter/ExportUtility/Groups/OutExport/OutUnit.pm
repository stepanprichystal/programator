...
# Author:SPR
#-------------------------------------------------------------------------------------------#
package Programs::Exporter::ExportUtility::Groups::OutExport::OutUnit;
...
use aliased 'Programs::Exporter::ExportUtility::Groups::OutExport::OutExport';
...
sub new {
	...
	$self->{"unitExport"} = OutExport->new($self->{"unitId"}, UnitEnums->GetTitle($self->{"unitId"}));
