package Programs::Exporter::ExportUtility::Groups::MDIExport::MDIExportTmp;
...
use aliased "Programs::Exporter::ExportChecker::Groups::MDIExport::Presenter::ImpUnit"  => "Unit";
use aliased "Programs::Exporter::ExportUtility::Groups::MDIExport::ImpWorkUnit" => "UnitExport";
...
sub Run {
	...
	print "\n========================== E X P O R T: " . UnitEnums->UnitId_IMP . " ===============================\n";
	print $resultMess;
	print "\n========================== E X P O R T: "
	  . UnitEnums->UnitId_IMP
	  . " - F I N I S H: "
	...
	unless ($succes) {
		...
		my @mess1 = ( "== EXPORT FAILURE === GROUP:  ".UnitEnums->UnitId_Imp."\n".$resultMess);
		$messMngr->ShowModal( -1, EnumsGeneral->MessageType_ERROR, \@mess1 );
	}
...
if ( $filename =~ /DEBUG_FILE.pl/ ) {
	...
	use aliased 'Programs::Exporter::ExportUtility::Groups::MDIExport::MDIExportTmp';

	my $jobId    = "f13610";
	my $stepName = "panel";
	my $inCAM    = InCAM->new();

	#GImp INPUT NIF INFORMATION
	my $stepToTest = "panel";
