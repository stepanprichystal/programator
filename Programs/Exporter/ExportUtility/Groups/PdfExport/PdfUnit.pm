...
#-------------------------------------------------------------------------------------------#
# Description: Represent "Unit" class for Pdf
#
...
# Author:SPR
#-------------------------------------------------------------------------------------------#
package Programs::Exporter::ExportUtility::Groups::PdfExport::PdfUnit;
...
use aliased 'Programs::Exporter::ExportUtility::Groups::PdfExport::PdfExport';
...
sub new {
	...
	$self->{"unitExport"} = PdfExport->new($self->{"unitId"}, UnitEnums->GetTitle($self->{"unitId"}));
