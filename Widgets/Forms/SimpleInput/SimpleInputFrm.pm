...
sub new {
	...
	$self->{"message"} = $message; #set name of script which show this window
	$self->{"result"} = $result; #set name of script which show this window
	$self->{"scriptName"} = caller(); #set name of script which show this window
