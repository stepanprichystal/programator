...
# Author:SPR
#-------------------------------------------------------------------------------------------#
package Packages::Routing::RoutLayer::FlattenRout::FlattenRout::ToolsOrder;
...
use aliased 'Packages::Routing::RoutLayer::FlattenRout::FlattenRout::SortTools';
...
sub ToolRenumberCheck {
	...
	my $unitRTM = UniRTM->new( $inCAM, $jobId, $self->{"stepList"}->GetStep(), $self->{"flatLayer"} );
