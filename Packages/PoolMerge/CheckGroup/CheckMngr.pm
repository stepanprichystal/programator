...
use aliased 'Packages::PoolMerge::CheckGroup::MasterJobHelper';
use aliased 'Packages::PoolMerge::CheckGroup::CheckHelper';
...
sub Run {
	...
	my $dimensionsRes = $self->_GetNewItem("Pcbs dimension");
	$mess          = "";
