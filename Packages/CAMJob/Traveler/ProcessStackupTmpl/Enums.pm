...
package Packages::CAMJob::Traveler::ProcessStackupTmpl::Enums;

use constant {
	LamType_STIFFPRODUCT     => "LamType_STIFFPRODUCT",        # Lamination of stiffener
	LamType_TAPEPRODUCT      => "LamType_TAPEPRODUCT",         # Lamination of tape on flex
	LamType_TAPESTIFFPRODUCT => "LamType_TAPESTIFFPRODUCT",    # Lamination of tape on stiffener
...
use constant {
	...
	ItemType_PADRUBBERPINK  => "ItemType_PADRUBBERPINK",       # rubber pad
	ItemType_PADRUBBERBROWN => "ItemType_PADRUBBERBROWN",      # rubber pad
	...
	ItemType_MATTAPE          => "ItemType_MATTAPE",
