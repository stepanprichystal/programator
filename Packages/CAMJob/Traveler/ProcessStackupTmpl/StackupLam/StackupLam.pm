...
# Author:SPR
#-------------------------------------------------------------------------------------------#
package Packages::CAMJob::Traveler::ProcessStackupTmpl::StackupLam::StackupLam;
...
#local library
use aliased 'Packages::CAMJob::Traveler::ProcessStackupTmpl::StackupLam::StackupLamItem';
