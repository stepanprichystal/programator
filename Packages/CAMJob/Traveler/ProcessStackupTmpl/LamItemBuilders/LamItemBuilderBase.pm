...
sub _ProcessStckpProduct {
	...
	$lam->AddChildItem( $item, "top", $itemId . "productTop",  $itemType, "TOP", "v".$IProduct->GetTopCopperNum(), undef, undef, undef );
	$lam->AddChildItem( $item, "bot", $itemId . "productBot",  $itemType, "BOT", "v".$IProduct->GetBotCopperNum(), undef, undef, undef );
