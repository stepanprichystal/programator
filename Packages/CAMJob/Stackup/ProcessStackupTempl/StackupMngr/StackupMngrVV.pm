...
# Author:SPR
#-------------------------------------------------------------------------------------------#
package Packages::CAMJob::Stackup::ProcessStackupTempl::StackupMngr::StackupMngrVV;
use base('Packages::CAMJob::Stackup::ProcessStackupTempl::StackupMngr::StackupMngrBase');
...
use aliased 'Packages::CAMJob::Stackup::ProcessStackupTempl::StackupLam::StackupLam';
