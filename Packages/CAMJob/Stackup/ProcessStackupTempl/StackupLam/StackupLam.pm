...
# Author:SPR
#-------------------------------------------------------------------------------------------#
package Packages::CAMJob::Stackup::ProcessStackupTempl::StackupLam::StackupLam;
...
#local library
use aliased 'Packages::CAMJob::Stackup::ProcessStackupTempl::StackupLam::StackupLamItem';
