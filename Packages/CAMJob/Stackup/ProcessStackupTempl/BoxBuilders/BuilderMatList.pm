...
# Author:SPR
#-------------------------------------------------------------------------------------------#
package Packages::CAMJob::Stackup::ProcessStackupTempl::BoxBuilders::BuilderMatList;
use base('Packages::CAMJob::Stackup::ProcessStackupTempl::BoxBuilders::BoxBuilderBase');

use Class::Interface;
&implements('Packages::CAMJob::Stackup::ProcessStackupTempl::BoxBuilders::IBoxBuilder');
...
use aliased 'Packages::CAMJob::Stackup::ProcessStackupTempl::BoxBuilders::BuilderMainHelper';
