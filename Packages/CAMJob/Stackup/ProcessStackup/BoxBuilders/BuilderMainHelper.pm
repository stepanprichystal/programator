...
# Author:SPR
#-------------------------------------------------------------------------------------------#
package Packages::CAMJob::Stackup::ProcessStackup::BoxBuilders::BuilderMainHelper;
...
sub DrawPad {
	...
	# 1) Define styles
	$txtStckpStyle->SetColor( Color->new( 0, 0, 0 ) ) if ( defined $txtStckpStyle );
	...
	elsif ( $itemType eq Enums->ItemType_PADFILM ) {
