...
sub Build {
	...
	# BOX Header
	my $headerTbl = $self->{"tblDrawing"}->AddTable( "Header", undef );
	...
	# BOX Title
	my $titleTbl = $self->{"tblDrawing"}->AddTable( "Title", undef, $borderStyle );
	...
	# BOX Main
	my $mainTbl = $self->{"tblDrawing"}->AddTable( "Main", undef, $borderStyle );
	...
	# BOX Info
	my $infoTbl = $self->{"tblDrawing"}->AddTable( "Info", undef, $borderStyle );
