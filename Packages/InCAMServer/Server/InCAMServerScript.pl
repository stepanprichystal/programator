...
use aliased 'Packages::InCAMServer::Server::CreateServer';
use aliased 'Packages::InCAMServer::Server::Helper';
use aliased 'Packages::InCAMServer::Server::Enums';
...
$main::configPath = GeneralHelper->Root() . "\\Packages\\InCAMServer\\Config";
...
Log::Log4perl->init( GeneralHelper->Root() . "\\Packages\\InCAMServer\\Server\\Logger.conf" );
