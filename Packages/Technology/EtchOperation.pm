...
sub GetCompensation {
		...
		if ($innerPosition) {
					   %compensationAttr = (
									...
									'30' => {'level'=> [2, 1.9, 1.8, 1.7, 1.6, 1.5, 1.4, 1.3, 1.2, 1.1, 1, 0.65], 
											 'space'=>80
											},
									...
									'43' => {'level'=> [2, 1.9, 1.8, 1.7, 1.6, 1.5, 1.4, 1.3, 1.2, 1.1, 1, 0.45], 
											 'space'=>80
											},
									'60' => {'level'=> [2, 1.9, 1.8, 1.7, 1.6, 1.5, 1.4, 0.8], 
											 'space'=>100
											},
									'70' => {'level'=> [2, 1.9, 1.8, 1.7, 1.6, 1.5, 1.4, 0.7], 
											 'space'=>100
											},
									'75' => {'level'=> [2, 1.9, 1.8, 1.7, 1.6, 1.5, 1.4, 0.65], 
											 'space'=>100
											},
