...
sub GetCompensation {
		...
		if ($innerPosition) {
					   %compensationAttr = (
									...
									'30' => {'level'=> [2, 1.9, 1.8, 1.7, 1.6, 1.5, 1.4, 1.3, 1.2, 1.1, 1, 0.5], 
											 'space'=>100
											},
									'34' => {'level'=> [2, 1.9, 1.8, 1.7, 1.6, 1.5, 1.4, 1.3, 1.2, 1.1, 1, 0.5], 
											 'space'=>100
											},
									'35' => {'level'=> [2, 1.9, 1.8, 1.7, 1.6, 1.5, 1.4, 1.3, 1.2, 1.1, 1, 0.5], 
											 'space'=>100
											},
									'37' => {'level'=> [2, 1.9, 1.8, 1.7, 1.6, 1.5, 1.4, 1.3, 1.2, 1.1, 1, 0.5], 
											 'space'=>100
											},
									'43' => {'level'=> [2, 1.9, 1.8, 1.7, 1.6, 1.5, 1.4, 1.3, 1.2, 1.1, 1, 0.5], 
											 'space'=>100
											},
									'60' => {'level'=> [2, 1.9, 1.8, 1.7, 1.6, 1.5, 1.4, 0.7], 
											 'space'=>100
											},
									'70' => {'level'=> [2, 1.9, 1.8, 1.7, 1.6, 1.5, 1.4, 0.7], 
											 'space'=>100
											},
									'75' => {'level'=> [2, 1.9, 1.8, 1.7, 1.6, 1.5, 1.4, 0.7], 
											 'space'=>100
											},
									'95' => {'level'=> [2, 1.9, 1.8, 1.7, 0.7],
											 'space'=>120
											},
									'105' => {'level'=> [2, 1.9, 1.8, 1.7, 0.7],
											 'space'=>120
											},
									'130' => {'level'=> [2, 1.9, 1.8, 1.7], 
											 'space'=>150
											},
