...
use constant {
	...
	LAYERTYPE_nplt_bStiffcAdhMillTop => "nplt_stiffAdhcMill",    # depth milling of top stiffener adhesive from top
	LAYERTYPE_nplt_bStiffsAdhMillTop => "nplt_stiffAdhsMill",    # depth milling of bot stiffener adhesive from top
