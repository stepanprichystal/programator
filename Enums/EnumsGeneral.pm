...
use constant {
	...
	LAYERTYPE_nplt_bStiffcAdhMillTop => "nplt_stiffAdhcMillTop",    # depth milling of top stiffener adhesive from top
	LAYERTYPE_nplt_bStiffsAdhMillTop => "nplt_stiffAdhsMillTop",    # depth milling of bot stiffener adhesive from top
